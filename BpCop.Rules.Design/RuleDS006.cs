...
namespace BpCop.Rules.Design
{
    ...
    [ExportMetadata("RuleName", "DS006")]
    [ExportMetadata("Message", "Input field '{0}' should have a description")]
    [ExportMetadata("Description", "An input field on process page should have a description")]
    ...
    internal sealed class RuleDS006 : ICheckRule
    {
