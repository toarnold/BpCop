...
namespace BpCop.Rules.Programming
{
    ...
    [ExportMetadata("RuleName", "PG007")]
    [ExportMetadata("Message", "Choice logging is disabled")]
    [ExportMetadata("Description", "Consider to activate at least 'Errors Only' logging on choice stages.")]
    ...
    internal sealed class RulePG007 : ICheckRule
    {
