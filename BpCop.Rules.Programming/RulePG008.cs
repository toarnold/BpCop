...
namespace BpCop.Rules.Programming
{
    ...
    [ExportMetadata("RuleName", "PG008")]
    [ExportMetadata("Message", "Choice/Otherwise logging is disabled")]
    [ExportMetadata("Description", "Consider to activate at least 'Errors Only' logging on choice/otherwise stages.")]
    ...
    internal sealed class RulePG008 : ICheckRule
    {
        public IEnumerable<CheckResult> CheckRule(CheckRuleData data)
        {
            ...
            return data.Asset.Stages.OfType<ChoiceEndStage>()
